...
namespace assms.api.DAL.Data.Migrations
{
    ...
    [Migration("20250926235235_AssetTable-Refactored")]
    partial class AssetTableRefactored
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("assms.entities.Models.RoleModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("assms.entities.Models.AssetImage", b =>
                {
                    b.HasOne("assms.entities.Models.AssetModel", "Asset")
                        .WithMany("Images")
